...
class _MatchmakingScreenState extends State<MatchmakingScreen> {
  ...
  Future<void> _loadPotentialMatches() async {
    ...
    try {
      ...
      // Sort by most filters in common
      matches.sort((a, b) => (b['commonFilterCount'] as int).compareTo(a['commonFilterCount'] as int));
  ...
  Future<void> _handleIgnore(int index) async {
    ...
    final matchUid = currentMatch['uid'] as String?;
    if (matchUid != null) {
      try {
